...
- Live stream: streamers start it with Record in the header (camera, video file, or a window/tab such as YouTube); everyone can watch with Play. A live chat with the same tools sits beside the video.
- German / English
