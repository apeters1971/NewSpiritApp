  ...
  const ENTRIES = [
    {
      ...
      items: {
        de: [
          ...
          "Nächster Termin bleibt nach dem Ende noch den nächsten Kalendertag stehen, wenn danach nichts kommt. Liegt am Folgetag schon ein Termin, wechselt es sofort nach der Endzeit.",
          "Titellisten teilen sich in Set 1, Set 2 und Zugabe. Kopieren übernimmt die Überschriften.",
        ],
        en: [
          ...
          "Next date stays up through the next calendar day when nothing follows. If the following day already has a date, it switches as soon as the event ends.",
          "Title lists group into Set 1, Set 2, and Encore. Copy includes those headings.",
        ],
      },
    },
    {
      ...
      items: {
        de: [
          ...
          "Für Band- und Orchestertermine kannst du in der Verwaltung eine Gage pro Person in Euro setzen. Einzelne Personen können abweichend gesetzt werden. Ab 0 € bleibt sie unsichtbar.",
          "Band, Orchester und Technik können unter persönlichen Daten optional IBAN und BIC hinterlegen. Die Angaben stehen nicht im Adressbuch.",
        ],
        en: [
          ...
          "On band and orchestra dates the controller can set a fee per person in euros. Individual people can get a different amount. At 0 € it stays hidden.",
          "Band, orchestra, and technicians can optionally add IBAN and BIC under personal info. Those details stay out of the address book.",
        ],
      },
    },
    {
    ...
    },
    {
      ...
      items: {
        de: [
          ...
          "Aus der Warteschlange kannst du Dateien einem bestehenden Song zuordnen, nicht nur einen neuen anlegen.",
        ],
        en: [
          ...
          "From the queue you can assign files to an existing song, not only create a new one.",
        ],
      },
    },
    {
