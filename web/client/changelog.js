  ...
  const ENTRIES = [
    {
      ...
      items: {
        de: [
          ...
          "Annehmen, Absagen und Löschen am eigenen Termin liegen in einem eigenen Planer-Streifen mit Symbolen, getrennt von Ja, Vielleicht und Nein.",
          "Am Termin ersetzen Symbole die Knöpfe Kommentare, Titel, Termin-Chat und Galerie. Rechts oben im Terminblock liegt ein Menü mit allen Aktionen, darunter Zeitplan und VVK/Werbung.",
        ...
        en: [
          ...
          "Accept, cancel, and delete on your own date sit in a planner strip with icons, apart from Yes, Maybe, and No.",
          "On a date, icons replace the Comments, Titles, Event chat, and Gallery buttons. A menu at the top right of the date block lists every action, including Schedule and Tickets / promo.",
