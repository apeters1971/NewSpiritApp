(() => {
  ...
  const dict = {
    de: {
      ...
      channelsHint: "Kanäle 1–96 für Chor, Band und Orchester. Jeder Kanal kann einer Person und einem Kommentar zugeordnet werden.",
      errChannel: "Unbekannter Kanal",
      errChannelRole: "Kanäle nur für Chor, Band oder Orchester",
    ...
    en: {
      ...
      channelsHint: "Channels 1–96 for choir, band, and orchestra. Assign a person and a comment to each channel.",
      errChannel: "Unknown channel",
      errChannelRole: "Channels are only for choir, band, or orchestra",
